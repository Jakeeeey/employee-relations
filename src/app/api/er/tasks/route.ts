...
import { taskService } from "../../../../modules/er/tasks/services/taskService";
import { CreateTaskSchema } from "../../../../modules/er/tasks/type";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const tasks = await taskService.fetchAll(userId);
