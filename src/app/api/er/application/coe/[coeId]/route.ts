...
import { UpdateCOESchema } from "@/modules/er/application/coe/type";
...
export async function PATCH(
  ...
  try {
    ...
    const validatedData = UpdateCOESchema.parse(body);

    const updatedRequest = await COEService.update(parseInt(coeId), validatedData);
