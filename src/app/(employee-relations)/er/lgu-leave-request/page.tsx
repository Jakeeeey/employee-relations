...
export const metadata: Metadata = {
  title: "LGU Leave Request | Employee Relations",
  description: "Civil Service Form No. 6 Application for Leave Management",
};
...
export default async function LguLeaveRequestPage() {
