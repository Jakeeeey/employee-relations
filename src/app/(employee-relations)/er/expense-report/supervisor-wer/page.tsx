...
import { SupervisorWERModule } from "@/modules/er/expense-report/supervisor-wer";
...
export default async function Page() {
    ...
    return (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Expense Report</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
            ...
            <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 bg-slate-50/50 dark:bg-slate-950/10">
                {userId ? (
                    <SupervisorWERModule userId={userId} />
                ) : (
                    <div className="flex items-center justify-center p-8">
                        <p className="text-muted-foreground">Unable to load user authorization context</p>
                    </div>
                )}
            </main>
        </div>
