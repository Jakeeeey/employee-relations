import { TravelRequestModule } from "@/modules/er/travel-request/TravelRequestModule";
...
export const metadata: Metadata = {
  title: "Travel Request | Employee Relations",
  description: "Manage and file your travel requests",
};
