...
import type {
  PortalChecklistItem,
  PortalSession,
} from "@/modules/er/employee-portal/types/portal-checklist.schema";
import {
  PortalTrainingResponseSchema,
  type PortalTrainingItem,
} from "@/modules/er/employee-portal/types/portal-training.schema";
import {
  PortalEquipmentResponseSchema,
  type PortalEquipmentItem,
} from "@/modules/er/employee-portal/types/portal-equipment.schema";
import { uploadPortalFile } from "./portalUpload";
